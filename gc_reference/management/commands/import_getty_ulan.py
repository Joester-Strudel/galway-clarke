...
from gc_reference.models import (
    IsoLanguage,
    UlanSubject,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        xml_files = sorted(f for f in os.listdir(ULAN_FOLDER) if f.endswith(".xml"))
    ...
    def import_single_file(self, filepath: str):
        ...
        # ---------------------------------------------------------
        self._import_associative_relationships(
            subject, subject_el.find("Associative_Relationships")
        )

        # ---------------------------------------------------------
        # SUBJECT CONTRIBUTORS
        # ---------------------------------------------------------
        self._import_subject_contributors(
            subject, subject_el.find("Subject_Contributors")
        )
