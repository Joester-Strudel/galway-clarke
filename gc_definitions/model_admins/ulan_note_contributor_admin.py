...
# First-Party Imports
from ..models import UlanNoteContributor


@admin.register(UlanNoteContributor)
class UlanNoteContributorAdmin(SimpleHistoryAdmin, ModelAdmin):
    # List Display
    list_display = [
        "formatted_note",
    ...
    @display(description="Note", ordering="note__note_text")
