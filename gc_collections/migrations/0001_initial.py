    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(help_text='The organization this collection belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='collections', to='gc_users.organization', verbose_name='Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(blank=True, db_constraint=False, help_text='The organization this collection belongs to.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='gc_users.organization', verbose_name='Organization')),
            ],
            options={
